...
In short, `plot3` provides:
  * A convenient wrapper around many `ggplot2` functions, losing the need to write functions such as `ggplot()`, `geom_col()`, `facet_wrap()`, `labs()`, etc. over and over again
...
You can install the released version of plot3 from [CRAN](https://CRAN.R-project.org) with:
